    ...
    <main className="min-h-screen">
      ...
      <section className="relative overflow-hidden px-4 pt-20 pb-28 sm:px-6 lg:px-8">
        <div className="pointer-events-none absolute inset-0">
          <div className="absolute top-0 left-1/2 h-[700px] w-[900px] -translate-x-1/2 rounded-full bg-amber-500/[0.07] blur-[150px]" />
          <div className="absolute top-60 right-0 h-[400px] w-[500px] rounded-full bg-amber-600/[0.05] blur-[120px]" />
          <div className="absolute bottom-0 left-0 h-[300px] w-[400px] rounded-full bg-amber-700/[0.04] blur-[100px]" />
        </div>
        <div className="relative mx-auto max-w-4xl text-center">
          <div className="mb-6 inline-block rounded-full border border-amber-500/30 bg-amber-500/10 px-4 py-1.5 text-sm font-medium text-amber-400">
          ...
          <a
            href="#form"
            className="group relative inline-block overflow-hidden rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 px-10 py-4 text-lg font-bold text-black shadow-lg shadow-amber-500/25 transition-all hover:shadow-amber-500/40 hover:scale-[1.02]"
          >
            Claim Your Spot
        ...
        <div className="mx-auto max-w-4xl">
          <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
            {[
              ...
              <div
                key={i}
                className="flex items-center justify-center gap-2 rounded-xl border border-white/[0.06] bg-white/[0.02] px-4 py-3 text-sm font-medium text-gray-300"
              >
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <h2 className="mb-3 text-center text-3xl font-bold sm:text-4xl">
            ...
            <span className="text-amber-400">Dalam Satu Platform</span>
          </h2>
          ...
          <div className="grid gap-8 lg:grid-cols-3">
            {featureGroups.map((group, gi) => (
              <div key={gi}>
                <h3 className="mb-5 text-lg font-bold text-amber-400">{group.title}</h3>
                <div className="space-y-3">
                  {group.features.map((f, fi) => (
                    <div
                      key={fi}
                      className="rounded-xl border border-white/[0.06] bg-white/[0.02] p-5 backdrop-blur-sm transition hover:border-amber-500/20 hover:bg-white/[0.04]"
                    >
                      <h4 className="mb-1 font-semibold">{f.name}</h4>
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <p className="mb-3 text-center text-sm font-medium uppercase tracking-widest text-amber-500">
            Testimoni
          </p>
      ...
      <section id="pricing" className="px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <div className="rounded-3xl border border-amber-500/20 bg-gradient-to-b from-amber-500/[0.05] to-transparent p-8 sm:p-12">
            <div className="mb-2 text-center text-sm font-bold uppercase tracking-widest text-amber-400">
              Founder&apos;s Deal
            </div>
            ...
            <div className="grid gap-6 sm:grid-cols-2">
              ...
              >
                <div className="absolute -top-3 left-6 rounded-full bg-amber-500 px-3 py-1 text-xs font-bold text-black">
                  BEST VALUE
                </div>
                <h3 className="mb-1 text-xl font-bold">Full Payment</h3>
                <p className="mb-4 text-sm text-gray-400">Bayar sekali, akses selamanya</p>
                <div className="mb-1 text-4xl font-extrabold">Rp 4.500.000</div>
                <p className="mb-6 text-sm text-amber-400">Hemat Rp 500.000</p>
                <ul className="space-y-2 text-sm text-gray-300">
                  <li className="flex items-center gap-2">
                    <span className="text-amber-400">&#10003;</span> Lifetime access semua fitur
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="text-amber-400">&#10003;</span> Free update selamanya
                  </li>
                  <li className="flex items-center gap-2">
              ...
              >
                ...
                <p className="mb-4 text-sm text-gray-400">Bayar 2x dalam 30 hari</p>
                <div className="mb-1 text-4xl font-extrabold">
                  Rp 2.250.000
                  <span className="text-lg font-normal text-gray-400"> x 2</span>
                </div>
                <p className="mb-6 text-sm text-gray-400">Total: Rp 4.500.000</p>
                <ul className="space-y-2 text-sm text-gray-300">
                  <li className="flex items-center gap-2">
                    <span className="text-amber-400">&#10003;</span> Lifetime access semua fitur
                  </li>
            ...
            <div className="mt-8 flex flex-col items-center gap-2 text-center text-sm text-gray-400">
              <p>
          ...
          >
            ...
            <div className="mb-5">
              ...
              <input
                ...
                className="w-full rounded-lg border border-white/[0.08] bg-[#0a0a0f] px-4 py-3 text-white placeholder-gray-500 outline-none transition focus:border-amber-500/50"
            ...
            <div className="mb-5">
              ...
              <div className="flex">
                ...
                <input
                  ...
                  className="w-full rounded-r-lg border border-white/[0.08] bg-[#0a0a0f] px-4 py-3 text-white placeholder-gray-500 outline-none transition focus:border-amber-500/50"
                  ...
                  <label
                    ...
                    className={`relative flex cursor-pointer items-center justify-center gap-2 rounded-lg border p-3 text-sm font-medium transition ${
                      form.paymentMethod === pm.value
                        ...
                        : "border-white/[0.08] bg-[#0a0a0f] text-gray-400 hover:border-amber-500/30"
                    }`}
                  >
                    <input
                      type="radio"
                    ...
                    {pm.label}
                    {pm.badge && (
                      <span className="absolute -top-2 -right-1 rounded-full bg-amber-500 px-1.5 py-0.5 text-[10px] font-bold text-black">
                        {pm.badge}
                      </span>
                    )}
                  </label>
            ...
            <button
              type="submit"
              disabled={loading}
              className="group relative w-full overflow-hidden rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 py-4 text-lg font-bold text-black shadow-lg shadow-amber-500/25 transition-all hover:shadow-amber-500/40 disabled:opacity-50"
            >
      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full border border-amber-500/20 bg-amber-500/10 text-3xl">
            \uD83D\uDEE1\uFE0F
          </div>
          <h2 className="mb-3 text-2xl font-bold">7 Hari Money-Back Guarantee</h2>
